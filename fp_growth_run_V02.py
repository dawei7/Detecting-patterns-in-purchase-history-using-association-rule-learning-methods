...
def associationRule(freqItemSet, itemSetList, minConf, maxConf):
    ...
    for itemSet in freqItemSet:
        ...
        for s in subsets:
            ...
            # Nuumber of tranactiions
            numTransaction = len(itemSetList)
...
freqItemSet, rules = fpgrowthFromDataFrame(data, minSupRatio=0.005,maxSupRatio=1, minConf=0.5, maxConf=1) #Success
...
# Time activation function \frac{1}{\left(1+e^{-\left(x-3\right)}\right)}