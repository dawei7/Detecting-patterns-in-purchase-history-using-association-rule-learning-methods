...
rules = fpgrowthFromDataFrame(df_data_simple_withdate, minSupRatio=0.5, maxSupRatio=1, minConf=0, item_col=1, date_col=2, max_date='2022-11-10', date_range=10, date_sensitivity = lambda x: 1 / (1 + math.exp(-10*x+5))) #Only Date
